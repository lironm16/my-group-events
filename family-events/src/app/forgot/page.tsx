  ...
  return (
    <main className="container-page max-w-md mx-auto space-y-4">
      ...
      <form onSubmit={submit} className="space-y-2">
        <input autoComplete="off" className="w-full border p-2 rounded bg-white dark:bg-transparent border-gray-200 dark:border-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 appearance-none dark:[-webkit-text-fill-color:#e5e7eb]" placeholder="שם משתמש / כינוי" value={identifier} onChange={e=>setIdentifier(e.target.value)} />
